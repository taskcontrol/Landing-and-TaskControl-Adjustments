...
//print $spaw_root;// instance counter (static)
...
class SPAW_Wysiwyg {
  ...
  function getHtml()
  {
    ...
    if (SPAW_Util::checkBrowser())
    {
      ...
      $buf.= '<textarea id="'.$n.'" name="'.$orn.'" style="width:'.$this->getWidth().'; height:'.$this->getHeight().'; display:none;" class="SPAW_'.$this->theme.'_editarea" onchange="SPAW_html_on_change(\''.$n.'\')">';
