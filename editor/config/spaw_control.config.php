...
if (file_exists("/home/admin/web/taskcontrol.co/public_html/includes/common.php"))
{
	define('IN_SITE', 	true);
	include_once("/home/admin/web/taskcontrol.co/public_html/includes/common.php");
