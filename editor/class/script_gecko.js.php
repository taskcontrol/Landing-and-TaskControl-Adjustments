  ...
  {
    var wnd = window.open(spaw_dir+'dialogs/colorpicker.php?lang=' 
  ...
  function SPAW_hyperlink_click(editor, sender)
  {
    ...
    var wnd = window.open(spaw_dir+'dialogs/a.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
 ...
 /***********************/
  ...
  {
    var wnd = window.open(spaw_dir+'dialogs/img_library.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
  ...
  function SPAW_image_prop_click(editor, sender)
  {
    ...
    if (im)
    {
      ...
      var wnd = window.open(spaw_dir+'dialogs/img.php?lang=' 
        + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
        + document.getElementById('SPAW_'+editor+'_theme').value
  ...
  {
      var wnd = window.open(spaw_dir+'dialogs/table.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
  ...
  function SPAW_table_cell_prop_click(editor, sender)
  {
    ...
    if (cd)
    {
      ...
      var wnd = window.open(spaw_dir+'dialogs/td.php?lang=' 
      + document.getElementById('SPAW_'+editor+'_lang').value + '&theme=' 
      + document.getElementById('SPAW_'+editor+'_theme').value
