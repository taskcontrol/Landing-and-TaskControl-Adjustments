...
SPAW_toggle_borders(editor,this[editor+'_rEdit'].document.body,null);
  ...
  function SPAW_showColorPicker(editor,curcolor) {
    return showModalDialog(spaw_dir + 'dialogs/colorpicker.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value, curcolor, 
  ...
  */
  ...
  function SPAW_hyperlink_click(editor, sender)
  {
	...
	if (a)
	{
      ...
      var naProps = showModalDialog(spaw_dir + 'dialogs/a.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value, aProps, 
  ...
  function SPAW_image_insert_click(editor, sender)
  {
    ...
    var imgSrc = showModalDialog(spaw_dir+'dialogs/img_library.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value+'&request_uri='+escape(window.location.href), '', 
  ...
  function SPAW_image_prop_click(editor, sender)
  {
    ...
    if (im)
    {
      ...
      var niProps = showModalDialog(spaw_dir + 'dialogs/img.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value, iProps, 
  ...
  function SPAW_table_create_click(editor, sender)
  {
    if (window.frames[editor+'_rEdit'].document.selection.type != "Control")
    {
      ...
      var nt = showModalDialog(spaw_dir + 'dialogs/table.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value+'&request_uri='+escape(window.location.href), null, 
        'dialogHeight:250px; dialogWidth:366px; resizable:no; status:no');  
  ...
  function SPAW_table_prop_click(editor, sender)
  {
    ...
    var ntProps = showModalDialog(spaw_dir + 'dialogs/table.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value+'&request_uri='+escape(window.location.href), tProps, 
      'dialogHeight:250px; dialogWidth:366px; resizable:no; status:no');  
  ...
  function SPAW_table_cell_prop_click(editor, sender)
  {
    ...
    if (cd)
    {
      ...
      var ncProps = showModalDialog(spaw_dir + 'dialogs/td.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value+'&request_uri='+escape(window.location.href), cProps, 
        'dialogHeight:220px; dialogWidth:366px; resizable:no; status:no');  
  ...
  function SPAW_confirm(editor,block,message) {
    return showModalDialog(spaw_dir + 'dialogs/confirm.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value + '&block=' + block + '&message=' + message, null, 'dialogHeight:100px; dialogWidth:300px; resizable:no; status:no');  
  }
  ...
  function SPAW_html_on_change(editor)
  {
