{if $flag == 0}
<table border="0" cellpadding="0" cellspacing="1" height="20%" width="95%" class="stdTableBorder" >
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
			 ...
			 <table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td width="31%" class="bodytextblack" align="center">{if $earn_membership[earn].membership_fees != ''}{$Curreny}&nbsp;{$earn_membership[earn].membership_fees|string_format:"%.2f"}{else}{$Curreny}&nbsp;0.00{/if}</td>
				</tr>					
				{/section}
				<tr>
				    <td colspan="3">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">{if $earn_withdraw[earn1].amount != ''}{$Curreny}&nbsp;{$earn_withdraw[earn1].amount|string_format:"%.2f"}{else}{$Curreny}&nbsp;0.00{/if}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">{if $earn_withdraw_money[earn_money].amount != ''}{$Curreny}&nbsp;{$earn_withdraw_money[earn_money].amount|string_format:"%.2f"}{else}{$Curreny}&nbsp;0.00{/if}</td>
				</tr>			
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td width="31%" class="bodytextblack" align="center">{$Curreny}&nbsp;{if $earn_cancel[earn2].Fees!=''} {$earn_cancel[earn2].Fees} {else} 0.00{/if}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="3">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">{if $earn_premium[earn3].Fees != ''}{$Curreny}&nbsp;{$earn_premium[earn3].Fees|string_format:"%.2f"}{else}{$Curreny}&nbsp;0.00{/if}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">{if $earn_urgent[earn4].Fees != ''}{$Curreny}&nbsp;{$earn_urgent[earn4].Fees|string_format:"%.2f"}{else}{$Curreny}&nbsp;0.00{/if}</td>
				</tr>
				{/section}				
				<tr>
				    <td colspan="4">&nbsp;</td>
