		...
		<td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr>
					...
					<td colspan="6" class="varnormal"><font color="#9D0027">Red Indicates Paypal's Pending Requested (Pending)</font></td>

				</tr>

				<tr>

					<td colspan="6" class="varnormal"><font color="#339900">Green Indicates Paypal's Pending Request Relieved</font></td>
			...
			{section name=pending_paypal_request loop=$Loop}
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					{/if}&nbsp;{$Curreny}&nbsp;{$pendingmoney[pending_paypal_request].amount}</td>
