	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">	
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">{$Curreny}&nbsp;{if $earn_premium[earn3].Fees != ''}{$earn_premium[earn3].Fees} {else} 0.00 {/if}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
	   ...
	   <td valign="top" align="center">
			...
			<table border="0" cellpadding="1" cellspacing="1" width="95%">
				...
				<tr class="{cycle values='list_A, list_B'}">
					...
					<td class="bodytextblack" align="center">{$Curreny}&nbsp;{if $earn_urgent[earn4].Fees != ''}{$earn_urgent[earn4].Fees}{else}0.00{/if}</td>
				</tr>
				{/section}
				<tr>
				    <td colspan="4">&nbsp;</td>
