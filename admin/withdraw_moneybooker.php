...
//*******************************************************************************//
//Here is where the MoneyBooker process is configured ***************************//
//*******************************************************************************//
//*******************************************************************************//
//*******************************************************************************//
...
{  
	...
	if($_POST['with_status'] == 1)
	{
		...
		$pays->InsertWIthdrawInMoneybooker($_POST);
	}	
...
elseif($Action == 'Edit')
{
	...
	$tpl->assign(array("T_Body"							=>	'withdarw_addedit_moneybooker'. $config['tplEx'],
						"JavaScript"			=> 	 array("withdraw_money.js"),
						"Action"				=>	$Action,
