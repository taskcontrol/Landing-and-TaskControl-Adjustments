      ...
      <section class="plans-comparison">
        ...
        <!-- AQUÏ COMIENZA LA TABLA -->
          ...
          <table class="table table-striped">
            ...
            <!-- AQUÍ COMIENZA EL CUERPO DE LA TABLA -->
            ...
            <tbody>
              ...
              <tr>
                <td>Ready-To-Use Project Document Templates</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>
              ...
              <tr>
                <td>Easy Emails Generation From Templates</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>
	       ...
	       <tr>
                <td>Team Working Hours Chart</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>
	       ...
	       <tr>
                <td>Licenses, Holidays & Vacations Management</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>
	       ...
	       <tr>
                <td>Gantt Chart with Automatic Quotation</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>			 
	       ...
	       <tr>
                <td>Tasks Management Tickets</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>	
	      ...
	      <tr>
	       ...
	       <tr>
                <td>Unlimited Projects Creation</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>	
	       ...
	       <tr>
                <td>Unlimited Roles Creation</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>	
	       ...
	       <tr>
                <td>Permission Defined By Role</td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>	
	      ...
	      <tr>
                <td>WhatIf Gantt Chart with Automatic Quotation</td>
	       ...
	       <tr>
                <td>Seamless G-Drive & DropBox Integration</td>
                <td><img src="templates/img/plans/checked false.png" alt="checked false"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>	
	       ...
	       <tr>
                <td>WorkFlow Creation Module</td>
                <td><img src="templates/img/plans/checked false.png" alt="checked false"></td>
                <td><img src="templates/img/plans/checked false.png" alt="checked false"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>
              ...
              <tr>
                <td>Legal Audit Record (SOX etc.)</td>
                <td><img src="templates/img/plans/checked false.png" alt="checked false"></td>
                <td><img src="templates/img/plans/checked false.png" alt="checked false"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>
	      ...
	      <tr>
                <td>Digital Signature For Legal Documents</td>
                <td><img src="templates/img/plans/checked false.png" alt="checked false"></td>
                <td><img src="templates/img/plans/checked false.png" alt="checked false"></td>
                <td><img src="templates/img/plans/checked true.png" alt="checked true"></td>
              </tr>
