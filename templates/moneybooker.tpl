<header class="header-login">
   <div class="container">
      <div class="content">
         <div class="row">
            <h1 class="revealOnScroll" data-animation="fadeInDown">Deposit (MoneyBooker)</h1>
...
<table border="0" bgcolor="#FFFFFF" width="100%" cellpadding="2">
	...
	<tr>
		<td align="center" class="successMsg">
			<strong>You are requested $&nbsp;{$requested_amount} amount for deposit in GoitGlobal through Moneybookers and after including your payment gateway commission your requested amount is: $&nbsp;{$final_total}.</strong>
		</td>
	</tr>
	<tr>
		<td height="20"></td>
	...
	<tr>
		<td align="center"> 
			<center> <form action="https://www.moneybookers.com/app/payment.pl" method="post" id="frmPago">
				<input type="hidden" name="pay_to_email" value="{$moneybooker_id}">
                ...
                <input type="hidden" name="status_url" value="http://goitglobal.com/moneyBookerIPN.php"/>  
