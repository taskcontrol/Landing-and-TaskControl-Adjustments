<header class="header-login">
   <div class="container">
      <div class="content">
         <div class="row">
            <h1 class="revealOnScroll" data-animation="fadeInDown">Shortlist1</h1>
				...
				<table width="100%" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0">
					...
					<tr>										
						...
						{else} 
							...
							{else}
								<a href="award_project_{$project_id}_{$clear_title}.html" class="footerlinkcommon2"><input id="btnbg"	 type="button" class="login_txt style5" value="{$lang.Award_Project}" onclick="javascript: document.location = 'award_project_{$project_id}_{$clear_title}.html';" style="float:none;"/></a>
							{/if}
						{/if}												 						
						</td>												
					</tr>
						...
						<td colspan="3" align="center" width="100%">
							<table border="0" cellpadding="0" cellspacing="0" align="left" width="100%">
								...
								<tr bgcolor="#D5D5D5">
									...
									<a href="post_project.php" class="footerlinkcommon23" onClick="Javascript: return chk_user('{$smarty.session.User_Id}');">
										<strong>{$lang.Posted_Project}</strong>
									</a> 
									 | 
									 <a href="#bid_list" onclick="JavaScript: popupWindowURL('send_project.php?project_id={$project_id}&pop_up=true','','625','525','','true','true');" class="footerlinkcommon23">
