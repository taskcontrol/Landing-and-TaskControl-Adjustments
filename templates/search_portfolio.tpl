<header class="header-login">
   <div class="container">
      <div class="content">
         <div class="row">
            <h1 class="revealOnScroll" data-animation="fadeInDown">Search_Portfolio</h1>
...
<b class="b1f"></b><b class="b2f"></b><b class="b3f"></b><b class="b4f"></b><div class="contentf"><div>
							...
							<span class="style9"><font color=black>{$lang.Search_Portfolio}</font></span>
						</div></div><b class="b4f"></b><b class="b3f"></b><b class="b2f"></b><b class="b1f"></b><br>
					
					<div style=" width:819px; clear:both;">
<b class="b1f"></b><b class="b2f"></b><b class="b3f"></b><b class="b4f"></b><div class="contentf"><div>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" ce>
			...
			<table width="100%" cellpadding="3" cellspacing="3" border="0">
				<tr>
					...
					<td width="30%">
						<table width="100%" cellpadding="3" cellspacing="3" border="0">
							<tr>
								<td class="bodytext"><strong>{$lang.User}</strong></td>
								<td class="bodytext">{$user_login_id[Portfolios]}</td>
							</tr>
							<tr>
								<td class="bodytext"><strong>{$lang.Rating}</strong></td>
								<td class="bodytext">
							...
							<tr>
								...
								{else}
									{$lang_common.Curreny}&nbsp;{$earning[Portfolios]}
								{/if}								</td>
							</tr>
							<tr>
	...
	<tr>
		<td align="center" class="bodytextblack"><strong>{$lang.Sorry}</strong></td>
	</tr>
	{/section}
	</table>
