      ...
      <div class="container">
       ...
       <!-- Collect the nav links, forms, and other content for toggling -->
		...
		{if !$smarty.session.User_Name}
		 ...
		 {/if}
		 <li><a href="home.html">Latest Projects</a></li>
		 <li><a href="all_seller_profiles.php">Find a Freelancer</a></li>
		 <li><a href="mantis/">Support</a></li>
		 <li><a href="tools.php">Tools</a></li>
	
		 {if $smarty.session.User_Name}
		 <li>|</li>
<!-- 		 <h1><span class="styleWelcome">{$lang_common.Welcome} {$smarty.session.User_Name}!</span></h1> -->
<!--		  <li><a href="account.php">{$smarty.session.User_Name}</a></li> -->
		  <li><a href="account.php">My Account</a></li> 		   
		  <li><a href="logout.php">Logout</a></li>
		 {/if}

<!-- 		  <li style="font-size: 9px;"><a href="mailto:info@goitglobal.com">Contact Us</a></li> -->
<!-- 		   <li style="font-size: 9px;"><a href="page_3.html">Help</a></li> -->
...
<!-- section with jobs --> {include file="$T_Body"}
