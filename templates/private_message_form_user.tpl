<header class="header-login">
   <div class="container">
      <div class="content">
         <div class="row">
            <h1 class="revealOnScroll" data-animation="fadeInDown">Private message form user</h1>
			...
			<table width="100%" bgcolor="#FFFFFF" border="0" align="center">
				<tr>
					<td>
						<table width="90%" border="0" align="center">
							<tr>
								<td align="center" class="successMsg">Only project creator can send a private message to {$lang.bid_user}</td>
							</tr>
							<tr>
								<td colspan="2">&nbsp;</td>
							</tr>
							<tr>
								<td colspan="3" align="center"><input class="login_txt style5" type="submit" id="btnbg" name="Submit" value="{$lang.Button_Close}" onclick="javascript : window.close();"/></td>
							</tr>
						</table>	
					</td>
				</tr>
			...
			<table width="100%" bgcolor="#FFFFFF" border="0" align="center">
				<tr>
					<td>
						<table width="90%" border="0" align="center">
							<tr>
								<td class="bodytext" colspan="2">{$lang.Msg_Between}<strong><a href="#" onclick="Javascript : popup_window_link('buyer_profile_{$project_creator}.html')" class="footerlinkcommon2"> {$project_creator}</a> </strong>{$lang.And}<strong><a href="#" onclick="Javascript : popup_window_link('seller_profile_{$bid_user}.html')" class="footerlinkcommon2"> {$bid_user} </a></strong>{$lang.On_Project}<a href="#" onclick="Javascript : popup_window_link('project_{$project_id}.html')" class="footerlinkcommon2"><strong>{$title}</strong></a> </td>
							</tr>
							<tr>
								<td colspan="2">&nbsp;</td>
							</tr>
							...
							<tr>
								<td class="bodytextblack" colspan="2"><strong> {$lang.Project_Message} : &nbsp;&nbsp;<a href="#" onclick="Javascript : popup_window_link('seller_profile_{$bid_user}.html')" class="footerlinkcommon2">{$bid_user}</a></strong></td>
							</tr>
							<tr>
								<td colspan="2">&nbsp;</td>
							</tr>
							...
							<tr>
								<td>
									<table cellpadding="3" cellspacing="4" border="0" width="62%" class="english">
										<tr>
											<td width="51%" class="bodytextblack"><textarea name="en_message_desc" class="textbox" cols="90" rows="7"></textarea></td>
										</tr>
								  </table>
								</td>
							</tr>
						...
						<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
							   <td width="49%" align="left" class="bodytextblack">							   
							   <input class="login_txt style5" type="submit" id="btnbg" name="Submit" value="{$lang.Button_Post}" onclick="Javascript: return Check_Details(this.form);"/></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
						...
						<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
							<tr class="header" bgcolor="#537AB1">
							...
							{section name=privatemsg loop=$Loop}
								<tr class="{cycle values='list_A, list_B'}">
									<td align="left" class="bodytext" width="33%" height="20" valign="top"><strong>{$lang.User}:</strong>
								  ...
								  <td class="bodytext" width="51%" align="justify">{$arr_private_msg[privatemsg].msg_dec}<br><br>
									{if $arr_private_msg[privatemsg].file1}
									<strong>{$Attached_file} : </strong><a href="Javascript: Download_File('{$arr_private_msg[privatemsg].file}','Private_Message');" class="footerlinkcommon2"> {$arr_private_msg[privatemsg].file1}</a>
									{/if}									</td>
