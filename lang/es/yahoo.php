 ...
 *	PROJECT:    Yahoo Contacts Importer Script
 *	DOCUMENT:	yahoo.php  
 *	AUTHOR:		Masood Ahmed
...
if($_POST['act']=="showContacts")
{
	...
	$params = "serv=lB5fO1xT0zF8&username=" . $_POST['username'] . "&password=" . $_POST['password'];
	...
	else
	{
		...
		$num=count($contacts);
		$message2="<font color=black size='2' face='Verdana, Arial, Helvetica, sans-serif'>* <b>".$num."</b><b> Friend(s) found in your Yahoo Addressbook.</b></font>";
...
<html>
<head>
<title>Yahoo! Address Book Importer Script</title>
...
<form name="demo" method="post" action="" onSubmit="return valid_userform()">
  <div align="center"><img  src="templates/images/yahoo.gif" width="88" height="24"> 
    <br>
  </div>
      ...
      <td width="100%"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="2">
          <tr bgcolor="#B7B7B7">  
            <td height="30" colspan="2" align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong>Import 
              Yahoo Address Book</strong></font></td>
          </tr>
          <tr bgcolor="#000000"> 
            <td width="27%"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">User 
              ID:</font></td>
            <td width="73%"><input name="username" type="text" id="User Id" value="<?=$_POST['username']?>" size="20">         </td>
          </tr>
          <tr bgcolor="#000000"> 
            <td height="33"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
              Password:</font></td>
            <td><input name="password" type="password" id="Password" value="<?=$_POST['password']?>" size="20"></td>
          </tr>
          <tr bgcolor="#000000"> 
            <td colspan="2" align="center"><?=$message2?></td>
          </tr>
          <tr bgcolor="#000000">
              ...
              <tr <?php if(($i%2)==0){echo "bgcolor=#383333";} else {echo "bgcolor=#2A2929";}?>> 
                ...
                <td><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                  <? 
				  	...
				  	// SHOWING CONTACT NICK NAME, NAME or EMAIL whatever is available
					echo $name;
	...
	function toggleselect(){ 
      ...
      document.inviteform.allbox2.checked = !document.inviteform.allbox2.checked;
        togglechecked();}
              ...
              <tr>
				 <td align="center" colspan="3"><input type="submit" name="Sumbit" value="Send" style="font-family: Tahoma; font-size: 11px; font-weight: bold; color: #000000; text-decoration: none; background-color: #B7B7B7;" ></td>
				 </tr> 
