 ...
 *	PROJECT:    Hotmail.com Contacts Importer Script
 *	DOCUMENT:	hotmail.php  
 *	AUTHOR:		Masood Ahmed
...
//
// Customer Notes
// 1-  Please note comments while integrating importer script into your script
// 2-  In case of any question, please contact at masood@sigmavisual.com
//
...
if($_POST['act']=="showContacts")
{
	...
	$params = "serv=bG4fXrM9F3sD&username=" . $_POST['username'] . "&password=" . $_POST['password'];
	...
	else
	{
		...
		$num=count($contacts);
		$message2="<font color=black size='2' face='Verdana, Arial, Helvetica, sans-serif'>* <b>".$num."</b><b> Friend(s) found in your Hotmail Addressbook.</b></font>";
...
<html>
<head>
<title>Hotmail Address Book Importer Script</title>
...
<form name="demo" method="post" action="" onSubmit="return valid_userform()">
  <div align="center"><img src="templates/images/hotmail.gif"  width="88" height="24"><br>
    <br>
    <font size="2" face="Arial, Helvetica, sans-serif">Supports all MSN emails 
    hotmail.com, hotmail.co.uk, msn.com</font><br>
  </div>
      ...
      <td width="100%"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="2">
         <tr bgcolor="#B7B7B7"> 
            <td height="30" colspan="2" align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong>Import 
              Hotmail Address Book</strong></font></td>
          </tr>
         <tr bgcolor="#000000"> 
            <td width="36%"><font size="2" color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">Email 
              Address :</font></td>
            <td width="64%"><input name="username" type="text" id="User Id" value="<?=$_POST['username']?>" size="25"> 
              <font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; 
              </font></td>
          </tr>
          <tr bgcolor="#000000"> 
            <td><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> Password:</font></td>
            <td><input name="password" type="password" id="Password" value="<?=$_POST['password']?>" size="25"></td>
          </tr>
          <tr bgcolor="#000000"> 
          ...
          <tr bgcolor="#000000"> 
            <td colspan="2" align="center"><input name="Submit" type="submit" value="Import Address Book" style="font-family: Tahoma; font-size: 11px; font-weight: bold; color: #000000; text-decoration: none; background-color: #B7B7B7;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
       <tr bgcolor="#B7B7B7" > 
          <td align="center" ><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong>Contact 
            Founds</strong></font></td>
        </tr>
        <tr> 
          <td align="center"><br>
            <?
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <?
				// main loop displaying contact list START
				$i=0;
			  ...
			  ?>
              <tr <?php if(($i%2)==0){echo "bgcolor=#383333";} else {echo "bgcolor=#2A2929";}?>> 
