...
// SEARCH FOR
$search        = 'Freelancerclonescript';

// REPLACE WITH
$replace    = 'Goitglobal'; // (used if queryType below is set to 'replace')

// DB Details
$hostname = "localhost";
$database = "c1bairesda_taskcontrol";
$username = "c1taskcontrol";
$password = "j6BRh3gN65tXnE";
